...
# 각 데이터에서 가까운 순서로 k개의 이웃을 찾아주는 클래스 (k-ditanceplot에 사용)
...
#####--------------------------------------
# 편의성을 위한 모듈 Print, Display, Markdown
...
def visualize_silhouette(estimator, data, columns=None, cluster_name='그룹번호',
    ...
    """
    군집이 잘 나뉘었는지를 데이터 하나하나 단위로 확인한다
